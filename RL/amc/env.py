...
from utils import AverageMeter, accuracy, prGreen,get_split_dataset
from reward import *
import math
...
class ChannelPruningEnv:
    ...
    def __init__(self, model, checkpoint, data, preserve_ratio, args, n_data_worker=4,
        ...
        # import os 
        # self.acc_recorder = open(os.path.join(args.output, 'log_acc.txt'), 'w')
    ...
    def step(self, action):
        ...
        if self._is_final_layer():
            ...
            if reward > self.best_reward:
                ...
                prGreen('New best reward: {:.4f}, {}: {:.4f}, acc_another:{},compress: {:.4f}'.format(self.best_reward, self.args.acc_metric,acc,acc_, compress_ratio))
    ...
    def prune_kernel(self, op_idx, preserve_ratio, preserve_idx=None):
        ...
        if weight.shape[2] == 1:  # 1x1 conv or fc
            from .utils import least_square_sklearn
    ...
    def _extract_layer_information(self):
        ...
        from utils import measure_layer_for_pruning
